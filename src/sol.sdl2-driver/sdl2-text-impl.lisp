...
(defmethod text-width ((impl sdl2-text-impl)
  ...
  (if surface
      (cffi:foreign-slot-value surface 'sdl2:sdl-surface 'sdl2:w)
      0))
...
(defmethod text-height ((impl sdl2-text-impl)
                        &aux
                          (surface (sdl-surface impl)))
  (if surface
      (cffi:foreign-slot-value surface 'sdl2:sdl-surface 'sdl2:h)
      0))

(defmethod text-set-dirty ((impl sdl2-text-impl))
  (when-let ((old-surface (sdl-surface impl)))
    (sdl2:sdl-free-surface old-surface)
...
(defun %render-text (text
  ...
  (let ((sdl-color
          (list
           'sdl2:r (media:r color)
           'sdl2:g (media:g color)
           'sdl2:b (media:b color)
           'sdl2:a (media:a color))))
    (sdl2-ttf:ttf-render-utf8-blended
