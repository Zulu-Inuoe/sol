...
(defclass input-manager (disposeable)
  ((game-controllers
    :type hash-table
...
(defmethod initialize-instance :around ((input input-manager) &key &allow-other-keys)
  (setf (gethash (bt:current-thread) *%input-managers*) input)
  (call-next-method))
